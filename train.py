...
def setup_training_loop_kwargs(
    ...
    args.training_set_kwargs = dnnlib.EasyDict(class_name='training.dataset.ImageWithSegmentationDataset', path=data, use_labels=False, max_size=None, xflip=False)
