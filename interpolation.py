...
def interpolation(
    ...
    *,
    ...
    print("HARI SHAPE ", hair.shape)
    w_h = project(G, hair, device=torch.device('cuda'))
    print("w_h shape: ", w_h.shape)
    w_p = project(G, identity, device=torch.device('cuda'))
...
def run_projection(
    ...
    hair_pil.save(f'{outdir}/target.png')
